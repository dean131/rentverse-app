// File Path: frontend/src/features/admin/components/PropertyReviewModal.tsx
'use client';

import { useState, useEffect } from 'react';
import { getPropertyById } from '@/features/properties/propertyService';
import { PropertyDetailed } from '@/lib/definitions';
import { PropertyReviewLayout } from './PropertyReviewLayout'; // Import the new layout
...
export const PropertyReviewModal = ({ propertyId, onClose, onActionComplete }: PropertyReviewModalProps) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in-fast">
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full h-[90vh] relative flex flex-col">
        <div className="flex-shrink-0 p-4 border-b flex justify-between items-center">
          <h2 className="text-xl font-bold text-gray-800 truncate pr-4">Review: {property?.title || '...'}</h2>
