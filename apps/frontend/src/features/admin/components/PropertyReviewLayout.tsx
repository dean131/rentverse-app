// Create a new file at: frontend/src/features/admin/components/PropertyReviewLayout.tsx
...
interface PropertyReviewLayoutProps {
  property: PropertyDetailed;
  onActionComplete: () => void;
}

export const PropertyReviewLayout = ({ property, onActionComplete }: PropertyReviewLayoutProps) => {
